...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  // Contacts urls
  'get /api/v1/contacts' : 'ContactsController.find',
  'get /api/v1/contacts/:id' : 'ContactsController.findOne',
  'post /api/v1/contacts' : 'ContactsController.create',

  // Notifications urls
  'get /api/v1/notifications' : 'NotificationsController.find',
  'get /api/v1/notifications/:id' : 'NotificationsController.findOne',
  'post /api/v1/notifications' : 'NotificationsController.create',

  // Command urls
  'get /api/v1/commands' : 'CommandsController.find',
  'get /api/v1/commands/:id' : 'CommandsController.findOne',
  'post /api/v1/commands' : 'CommandsController.create',
